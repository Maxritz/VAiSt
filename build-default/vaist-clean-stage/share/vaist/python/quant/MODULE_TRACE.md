# MODULE 05 TRACE — vaist_quant

## Purpose
Quantization/dequantization and packed-dot compatible paths

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
USE/EXTEND: unified Q8/Q4 block quantization and dequantization with explicit block sizing and capacity checks.
