...
enum class VaistWeightDtype : uint32_t {
    ...
    kQ4_1   = 4,  /**< GGUF q4_1: 4-bit, with sign. */
    kQ8_0   = 5,  /**< GGUF q8_0: 8-bit, per-block scale, block size 32. */
    kQ8_1   = 6,  /**< GGUF q8_1: 8-bit, with task data. */
    kQ5_0   = 7,  /**< GGUF q5_0: 5-bit, high bit. */
    kQ5_1   = 8,  /**< GGUF q5_1: 5-bit, high bit with sign. */
    kQ4_K   = 9,  /**< GGUF q4_K: 4-bit with per-block scale+min. */
    kQ5_K   = 10, /**< GGUF q5_K: 5-bit with per-block scale+min. */
    kQ6_K   = 11, /**< GGUF q6_K: 6-bit with per-row scale. */
    kQ3_K   = 12, /**< GGUF q3_K: 3-bit mixed-bit. */
    kQ2_K   = 13, /**< GGUF q2_K: 2-bit. */
    kIq4Nl  = 14, /**< GGUF IQ4_NL: nonlinearity-aware 4-bit. */
    kIq4Xs  = 15, /**< GGUF IQ4_XS: 4-bit extra-small with scale. */
    kIq2Xs  = 16, /**< GGUF IQ2_XS: 2-bit extra-small. */
    kIq1S   = 17, /**< GGUF IQ1_S: 1-bit scale. */
    kIq1M   = 18, /**< GGUF IQ1_M: 1-bit M scale. */
};
...
/** \brief Convert a GGUF ggml_type enum value to a VaistWeightDtype. */
inline VaistWeightDtype weight_dtype_from_gguf_ggml_type(uint32_t ggml_type) {
    switch (ggml_type) {
        case 2:  return VaistWeightDtype::kQ4_0;  /* GGUF_TYPE_Q4_0 */
        case 3:  return VaistWeightDtype::kQ4_1;  /* GGUF_TYPE_Q4_1 */
        case 6:  return VaistWeightDtype::kQ5_0;  /* GGUF_TYPE_Q5_0 */
        case 7:  return VaistWeightDtype::kQ5_1;  /* GGUF_TYPE_Q5_1 */
        case 8:  return VaistWeightDtype::kQ8_0;  /* GGUF_TYPE_Q8_0 */
        case 9:  return VaistWeightDtype::kQ8_1;  /* GGUF_TYPE_Q8_1 */
        default: return VaistWeightDtype::kF32;
    }
}
...
struct VaistTensorRef {
    ...
    /** \brief Raw GGUF ggml_type value (for reconstructing dtype in get_data).
     *         This is 100 + ggml_type, matching the C99 encoding convention. */
    uint32_t gguf_raw_dtype = 0;
    ...
    mutable std::vector<float> data_cache;
    ...
    const float* get_data() const {
        ...
        std::snprintf(desc.name, 256, "%s", name.c_str());
         if (is_quantized()) {
            desc.dtype = (VaistDType)gguf_raw_dtype;
