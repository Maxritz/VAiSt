# MODULE 06 TRACE — vaist_graph

## Purpose
Graph IR, operator registry, shape inference, planning and execution

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
NEW: graph node registry, compile state and execution plan over registered binary operators.
