# MODULE 12 TRACE — vaist_distributed

## Purpose
Transport, workers, collectives and parallel execution

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
USE/EXTEND: communicator and single-process collectives; multi-process operations fail explicitly as unsupported until a transport is attached.
