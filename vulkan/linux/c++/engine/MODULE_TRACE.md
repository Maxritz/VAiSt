# MODULE 10 TRACE — vaist_engine

## Purpose
Application-facing orchestration, sessions, generation and batching

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
NEW: application-facing engine/session lifecycle, cancellation and bounded generation output.
