# MODULE 02 TRACE — vaist_runtime

## Purpose
Backend-neutral runtime, memory, streams, Vulkan/CPU selection

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
NEW/EXTEND: backend abstraction, CPU buffers/streams, dynamic Vulkan loader detection, capability record.
