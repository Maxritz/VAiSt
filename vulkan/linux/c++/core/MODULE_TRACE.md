# MODULE 01 TRACE — vaist_core

## Purpose
Core ABI, status, diagnostics, versioning

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
KEEP/NEW: canonical ABI foundation. IMPLEMENTED: version, ABI, build info, status strings, diagnostics.
