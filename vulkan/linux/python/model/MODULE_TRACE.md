# MODULE 07 TRACE — vaist_model

## Purpose
Common model representation and GGUF/SafeTensors metadata loaders

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
USE/EXTEND: common model inspection boundary with validated GGUF and SafeTensors detection plus ONNX recognition.
