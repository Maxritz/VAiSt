# MODULE 08 TRACE — vaist_nn

## Purpose
Neural operators, attention primitives, RoPE, transformer building blocks

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
NEW: core neural primitives including ReLU, GELU, SiLU, RMSNorm, softmax and RoPE.
