# MODULE 09 TRACE — vaist_llm

## Purpose
Tokenizer, KV cache, sampling, decoding and speculative state

## Mandatory use
This module is the sole public boundary for its responsibility in the 12-library architecture.

## Classification
USE/EXTEND: KV storage, sampling and byte tokenizer baseline; explicit ownership and cancellation-safe state.
